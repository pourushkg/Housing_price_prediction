...
from housing.entity.config_entity import ModelPusherConfig,ModelTrainerConfig,ModelEvaluationConfig,TrainingPipelineConfig
from housing.util.util import real_yaml_file
...
class Configuration:
    ...
    def __init__(self,
        ...
        try:
            self.config_info = real_yaml_file(file_path=config_file_path)
